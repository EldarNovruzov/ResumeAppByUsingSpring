...
public class UserRestControllerTestIT implements RestTemplateHolder {
...
class MyDetails extends ResourceOwnerPasswordResourceDetails{
    public MyDetails(final Object obj){
        UserRestControllerTestIT controllerTestIT=(UserRestControllerTestIT) obj;
        ...
        setScope(scopes);
        setUsername("eldarnovruzov99@gmail.com");
        setPassword("1999eldar");
